...
public class ModelMapperConfig {
    ...
    enum DateFormat {
        ...
        DEFAULT_DATE_TIME_FORMAT("yyyy-MM-dd HH:mm:ss", DateFormat.TimeZone.GREENWICH_MEAN_TIME),
        DEFAULT_DATE_FORMAT("yyyy-MM-dd", DateFormat.TimeZone.GREENWICH_MEAN_TIME),
        DEFAULT_TIME_FORMAT("HH:mm:ss", DateFormat.TimeZone.GREENWICH_MEAN_TIME),
